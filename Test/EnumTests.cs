...
namespace CookComputing.XmlRpc
{
    ...
    public enum LongEnum : long
    {
        ...
        One = 1,
        Two = 2,
        MaxIntPlusOne = (long)int.MaxValue + 1,
    }
    ...
    public enum ULongEnum : ulong
    {
        ...
        One = 1,
        Two = 2,
        MaxUintPlusOne = (long)uint.MaxValue + 1,
    }

    [TestFixture]
    public class EnumTests
    {
        private const long maxIntPlusOne = (long)int.MaxValue + 1;
        private const ulong maxUintPlusOne = (ulong)uint.MaxValue + 1;
