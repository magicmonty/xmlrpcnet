...
namespace CookComputing.XmlRpc
{
    ...
    public class ProxyGenTest
    {
        ...
        public void Setup()
        {
            TestHelpers.StateNameService.Start(5678);
        }

        [TestFixtureTearDown]
        public void TearDown()
        {
            TestHelpers.StateNameService.Stop();
        }
        ...
        public void CheckProperties()
        {
            ...
            try { proxy.SystemListMethods(); }
            catch (XmlRpcMissingUrl) { }
            try { proxy.SystemMethodSignature("Foo"); }
            catch (XmlRpcMissingUrl) { }
            try { proxy.SystemMethodHelp("Foo"); }
            catch (XmlRpcMissingUrl) { }
        }
