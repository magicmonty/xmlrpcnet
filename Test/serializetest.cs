// --------------------------------------------------------------------------------------------------------------------
// <copyright file="serializetest.cs" company="">
//   
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
namespace CookComputing.XmlRpc
{
    ...
    public class SerializeTest
    {
        ...
        public void Int()
        {
            XmlReader rdr = Utils.Serialize(
                "SerializeTest.testInt",
                12345,
                Encoding.UTF8,
                new MappingActions { NullMappingAction = NullMappingAction.Ignore });
            Type parsedType, parsedArrayType;
            object obj = Utils.Parse(rdr, null, MappingAction.Error, out parsedType, out parsedArrayType);
        ...
        public void Double()
        {
            XmlReader xdoc = Utils.Serialize(
                "SerializeTest.testDouble",
                543.21,
                Encoding.UTF8,
                new MappingActions { NullMappingAction = NullMappingAction.Ignore });
            Type parsedType, parsedArrayType;
            object obj = Utils.Parse(xdoc, null, MappingAction.Error, out parsedType, out parsedArrayType);
    ...
    <param>
      <value>
        ...
        public void XmlRpcStruct()
        {
            ...
            XmlReader xdoc = Utils.Serialize(
                "SerializeTest.testXmlRpcStruct",
                xmlRpcStruct,
                Encoding.UTF8,
                new MappingActions { NullMappingAction = NullMappingAction.Ignore });
            Type parsedType, parsedArrayType;
        ...
        public void XmlRpcStructIListValue()
        {
            ...
            XmlReader xdoc = Utils.Serialize(
                "SerializeTest.XmlRpcStructIListValue",
                xmlRpcStruct,
                Encoding.UTF8,
                new MappingActions { NullMappingAction = NullMappingAction.Ignore });
        }
        ...
        {
            XmlReader xdoc = Utils.Serialize(
                "SerializeTest.testXmlRpcBoolean",
                new bool?(true),
                Encoding.UTF8,
                new MappingActions { NullMappingAction = NullMappingAction.Ignore });
            Type parsedType, parsedArrayType;
        ...
        {
            XmlReader xdoc = Utils.Serialize(
                "SerializeTest.testXmlRpcDouble",
                new double?(543.21),
                Encoding.UTF8,
                new MappingActions { NullMappingAction = NullMappingAction.Ignore });
            Type parsedType, parsedArrayType;
        ...
        {
            XmlReader xdoc = Utils.Serialize(
                "SerializeTest.testXmlRpcDateTime",
                new DateTime(2002, 7, 6, 11, 25, 37),
                Encoding.UTF8,
                new MappingActions { NullMappingAction = NullMappingAction.Ignore });
            Type parsedType, parsedArrayType;
