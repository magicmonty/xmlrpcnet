// --------------------------------------------------------------------------------------------------------------------
// <copyright file="serviceinfotest.cs" company="">
//   
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
namespace CookComputing.XmlRpc
{
    ...
    public class ServiceInfoTest
    {
        ...
        public void Int32()
        {
            ...
            Assert.AreEqual(XmlRpcType.tInt32, rpcType, "Int32 doesn't map to XmlRpcType.tInt32");
        ...
        public void Int64()
        {
            ...
            XmlRpcType rpcType = XmlRpcTypeInfo.GetXmlRpcType(type);
            Assert.AreEqual(XmlRpcType.tInt64, rpcType, "Int64 doesn't map to XmlRpcType.tInt64");
            string rpcString = XmlRpcTypeInfo.GetXmlRpcTypeString(type);
        ...
        public void Boolean()
        {
            ...
            XmlRpcType rpcType = XmlRpcTypeInfo.GetXmlRpcType(type);
            Assert.AreEqual(XmlRpcType.tBoolean, rpcType, "Boolean doesn't map to XmlRpcType.tBoolean");
            string rpcString = XmlRpcTypeInfo.GetXmlRpcTypeString(type);
            Assert.AreEqual(rpcString, "boolean", "Boolean doesn't map to 'boolean'");
        }
        ...
        public void Double()
        {
            ...
            XmlRpcType rpcType = XmlRpcTypeInfo.GetXmlRpcType(type);
            Assert.AreEqual(XmlRpcType.tDouble, rpcType, "Double doesn't map to XmlRpcType.tDouble");
            string rpcString = XmlRpcTypeInfo.GetXmlRpcTypeString(type);
        ...
        public void XmlRpcDateTime()
        {
            Type type = typeof(DateTime?);
            XmlRpcType rpcType = XmlRpcTypeInfo.GetXmlRpcType(type);
            Assert.AreEqual(XmlRpcType.tDateTime, rpcType, "XmlRpcDateTime doesn't map to XmlRpcType.tDateTime");
            string rpcString = XmlRpcTypeInfo.GetXmlRpcTypeString(type);
            Assert.AreEqual(rpcString, "dateTime", "XmlRpcDateTime doesn't map to 'dateTime'");
        }
        ...
        public void MultiDimIntArray()
        {
            Type type = typeof(Int32[,]);
            XmlRpcType rpcType = XmlRpcTypeInfo.GetXmlRpcType(type);
            Assert.AreEqual(XmlRpcType.tMultiDimArray, rpcType, "Int32[] doesn't map to XmlRpcType.tMultiDimArray");
            string rpcString = XmlRpcTypeInfo.GetXmlRpcTypeString(type);
            Assert.AreEqual(rpcString, "array", "Int32['] doesn't map to 'array'");
        }
        ...
        public void Struct()
        {
            ...
            XmlRpcType rpcType = XmlRpcTypeInfo.GetXmlRpcType(type);
            Assert.AreEqual(XmlRpcType.tStruct, rpcType, "struct doesn't map to XmlRpcType.tStruct");
            string rpcString = XmlRpcTypeInfo.GetXmlRpcTypeString(type);
            Assert.AreEqual(rpcString, "struct", "struct doesn't map to 'struct'");
        }
        ...
        public void NullableInt()
        {
            Type type = typeof(int?);
            XmlRpcType rpcType = XmlRpcTypeInfo.GetXmlRpcType(type);
            Assert.AreEqual(XmlRpcType.tInt32, rpcType, "int? doesn't map to XmlRpcType.tInt32");
            string rpcString = XmlRpcTypeInfo.GetXmlRpcTypeString(type);
            Assert.AreEqual(rpcString, "integer", "int? doesn't map to 'integer'");
        }
        ...
        public void NullableBool()
        {
            Type type = typeof(bool?);
            XmlRpcType rpcType = XmlRpcTypeInfo.GetXmlRpcType(type);
            Assert.AreEqual(XmlRpcType.tBoolean, rpcType, "bool? doesn't map to XmlRpcType.tBoolean");
            string rpcString = XmlRpcTypeInfo.GetXmlRpcTypeString(type);
            Assert.AreEqual(rpcString, "boolean", "bool? doesn't map to 'boolean'");
        }
